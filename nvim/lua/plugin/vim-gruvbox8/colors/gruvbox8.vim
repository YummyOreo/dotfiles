...
if &background ==# 'dark'
  ...
  hi IncSearch guifg=#282828 guibg=#fe8019 gui=reverse cterm=reverse
  ...
  hi Search guifg=#282828 guibg=#d65d0e gui=reverse cterm=reverse
  ...
  hi IncSearch guifg=#076678 guibg=#fbf1c7 gui=reverse cterm=reverse
  ...
  hi Search guifg=#458588 guibg=#fbf1c7 gui=reverse cterm=reverse
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi IncSearch ctermfg=109 ctermbg=235 cterm=reverse
    ...
    hi Search ctermfg=107 ctermbg=235 cterm=reverse
    ...
    hi IncSearch ctermfg=23 ctermbg=230 cterm=reverse
    ...
    hi Search ctermfg=29 ctermbg=230 cterm=reverse
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi IncSearch ctermfg=Blue ctermbg=Black cterm=reverse
    ...
    hi IncSearch ctermfg=Blue ctermbg=White cterm=reverse
    hi ModeMsg ctermfg=Yellow ctermbg=NONE cterm=bold
    hi MoreMsg ctermfg=Yellow ctermbg=NONE cterm=bold
    hi Question ctermfg=Magenta ctermbg=NONE cterm=bold
    hi Search ctermfg=Cyan ctermbg=White cterm=reverse
    hi SpellBad ctermfg=Red ctermbg=NONE cterm=italic,underline
    hi SpellCap ctermfg=Blue ctermbg=NONE cterm=italic,underline
    hi SpellLocal ctermfg=Cyan ctermbg=NONE cterm=italic,underline
    hi SpellRare ctermfg=Magenta ctermbg=NONE cterm=italic,underline
